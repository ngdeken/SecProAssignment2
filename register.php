...
<head>
    ...
    <title>Assignment 1 Sign Up by NG DE KEN A20EC0106</title>
...
<body>
    ...
    <form action="" method="post">
        <h2>Assignment 1 Create an account by NG DE KEN A20EC0106</h2>
...
?>
        <div class="container" style="background-color:#f1f1f1">
            <a href="index.php"><button type="button" class="Regbtn" style="border-radius: 25px;">Login Page</button></a>
        </div>
    </form>
</body>
